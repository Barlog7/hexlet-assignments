...
public class AppTest {
    ...
    void testIndex() throws Exception {
        MockHttpServletResponse responsePost = mockMvc
                .perform(get("/people")).andExpect(status().isOk()).andReturn().getResponse();
...
/*        MockHttpServletResponse response = mockMvc
        ...
        assertThat(response.getStatus()).isEqualTo(200);*/
        //assertThat(response.getContentType()).isEqualTo(MediaType.APPLICATION_JSON.toString());
        //assertThat(response.getContentAsString()).contains("[{\"firstName\": \"John\", \"lastName\": \"Smith\"},{\"firstName\": \"Jack\", \"lastName\": \"Doe\"},{\"firstName\": \"Jassica\", \"lastName\": \"Simpson\"},{\"firstName\": \"Robert\", \"lastName\": \"Lock\"}]");
    }
    @Test
    void testShow() throws Exception {
        MockHttpServletResponse responsePost = mockMvc
                .perform(get("/people/1")).andExpect(status().isOk()).andReturn().getResponse();
